		...
		IdempotentRetryAssert.retryAssert(
			...
			() -> {
				...
				_assertWorkflowLogsMakeLonger(
					...
					rewrittenText,
					StringBundler.concat(
						"You are an expert linguistic enhancer. Expand the ",
						"provided text by adding relevant and natural details ",
						"that clarify or enrich its meaning. Keep the ",
						"original tone, intent, and structure. Avoid ",
						"unnecessary embellishment, repetition, or creative ",
