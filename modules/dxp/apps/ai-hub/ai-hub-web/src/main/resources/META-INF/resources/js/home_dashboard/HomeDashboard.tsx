		...
		<div className="home-dashboard">
			<div className="home-dashboard__hero">
				<h2 className="home-dashboard__hero-title">
					{Liferay.Language.get('start-creating-something')}
				</h2>
			...
			<HomeDashboardSection
				...
				errorLabel={Liferay.Language.get('unable-to-load-agents')}
				hasError={agentsError}
				items={agents}
				link={{
					label: Liferay.Language.get('see-agents'),
					url: agentBuilderURL,
				}}
				renderItem={(item) => (
					<DashboardCard
			...
			<HomeDashboardSection
				emptyLabel={Liferay.Language.get('no-chatbots-created-yet')}
				errorLabel={Liferay.Language.get('unable-to-load-chatbots')}
				hasError={chatbotsError}
				items={chatbots}
				link={{
					label: Liferay.Language.get('see-chatbots'),
					url: chatbotsURL,
				}}
				renderItem={(item) => (
					<DashboardCard
