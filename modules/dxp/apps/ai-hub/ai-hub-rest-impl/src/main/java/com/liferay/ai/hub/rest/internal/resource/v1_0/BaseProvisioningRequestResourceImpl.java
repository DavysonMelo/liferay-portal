...
public abstract class BaseProvisioningRequestResourceImpl
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/ai-hub/v1.0/provisioning' -d $'{"customerName": ___, "liferayDXPURL": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
...
// LIFERAY-REST-BUILDER-HASH:548353307